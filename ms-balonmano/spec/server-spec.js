/**
 * @file server-spec.js
 * @description Fichero con la especificación de las pruebas TDD para server.js del MS Balonmano
    ...
    it('Devuelve MS Balonmano Acerca De', (done) => {
      supertest(app)
        ...
        .expect(function (res) {
          ...
          assert(res.body.hasOwnProperty('mensaje'));
          assert(res.body.mensaje === "Microservicio MS Balonmano: acerca de");
